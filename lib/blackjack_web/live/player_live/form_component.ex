  ...
  def render(assigns) do
    ...
    <div>
      ...
      >
        ...
        <.input field={@form[:chip_count]} type="number" label="Chip count" />
        <.input field={@form[:hands_played]} type="number" label="Hands played" />
        <.input field={@form[:hands_won]} type="number" label="Hands won" />
        <:actions>
