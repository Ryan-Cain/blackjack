defmodule BlackjackWeb.PlayerAuth do
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_blackjack_web_player_remember_me"
  ...
  def log_out_player(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      BlackjackWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_player:
      ...
      defmodule BlackjackWeb.PageLive do
        ...
        on_mount {BlackjackWeb.PlayerAuth, :mount_current_player}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{BlackjackWeb.PlayerAuth, :ensure_authenticated}] do
